...
import PaperBagBanner from "../../components/landing/PaperBagBanner";
...
const BoppTape = ({ brand, product, category, brandId, subCategoryId, q }) => {
    ...
    try {
      ...
      if (flags?.category) {
        ...
        const filteredProducts = dat?.data?.data.filter((product) => {
          return product.category === "6557df46301ec4f2f4266139";
        });
  ...
  useEffect(() => {
    ...
    if (product) {
      const paperBagProducts = product.filter(
        (product) => product.category?.name === "Paper Bag"
      );
      // console.log(boppTapeProducts);
      //console.log(product);
      setProducts(paperBagProducts);
    }
  }, [product]);
    ...
    if (flags?.size) {
      ...
      if (index === -1) {
        ...
        const filteredProducts = dat?.data?.data?.filter(
          (product) => product.category === "6557df46301ec4f2f4266139"
        );
        setProducts(filteredProducts);
      } else {
        temp.splice(index, 1);
  ...
  return (
    <>
      <Head>
        <title>Buy Paper Bags online | store.prempackaging </title>
        <meta name="title" content="Buy Paper Bags online" />
        <meta
          name="description"
          ...
          >
            <div className="mt-2 d-flex flex-column">
              <p className={styles.catalogpath}>
                ...
                <span className={styles.spanee}>Paper Bags</span>
              </p>
              <div
            ...
            <div className="row mt-4 d-flex" style={{ position: "relative" }}>
              ...
              >
                ...
                <div className={"mt-3 col-12 p-0 m-0" + styles.filterslayout}>
                  <div
                    className="w-100"
              ...
              >
                ...
                <div className={"mt-3 col-12 p-0 m-0" + styles.filterslayout1}>
                  <div
                    className="w-100"
                    style={{
                      height: "230px",
              ...
              <div
                className={"col-12 p-0 w-100 " + styles.productslistdivmobile}
              >
                {products && products.length > 0 ? (
                  products.slice(firstIndex, lastIndex).map((item, index) => (
                    <div
