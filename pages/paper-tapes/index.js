...
const BoppTape = ({ brand, product, category, brandId, subCategoryId, q }) => {
    ...
    try {
      ...
      if (flags?.category) {
        ...
        const filteredProducts = dat?.data?.data.filter((product) => {
          return product.category === "6557df71301ec4f2f4266145";
        });
  ...
  useEffect(() => {
    ...
    if (product) {
      const paperTapeProducts = product.filter(
        (product) => product.category?.name === "Paper Tape"
      );
    ...
    if (flags?.size) {
      ...
      if (index === -1) {
        ...
        const filteredProducts = dat?.data?.data?.filter(
          (product) => product.category === "6557df71301ec4f2f4266145"
        );
        setProducts(filteredProducts);
      } else {
        temp.splice(index, 1);
  ...
  return (
    <>
      <Head>
        <title>Buy Paper Tapes online | store.prempackaging </title>
        <meta name="title" content="Buy Paper Tapes online" />
        <meta
          name="description"
          content="Prem Industries India Limited is the leading paper packaging tape manufacturer in India. Now buy paper tapes online in India at affordable prices. Shop paper packaging tape online India"
        />
      </Head>
          ...
          >
            <div className="mt-2 d-flex flex-column">
              <p className={styles.catalogpath}>
                ...
                <span className={styles.spanee}>Paper Tapes </span>
              </p>
              <div
