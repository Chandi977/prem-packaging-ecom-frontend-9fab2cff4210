...
const BoppTape = ({ brand, product, category, brandId, subCategoryId, q }) => {
  ...
  useEffect(() => {
    ...
    if (product) {
      const boppTapeProducts = product.filter(
        (product) => product.category?.name === "BOPP Tape"
      );
  ...
  return (
    <>
      <Head>
        <title>Buy Best BOPP Tapes online | store.prempackaging </title>
        <meta name="title" content="Buy Best BOPP Tapes online" />
        <meta
          name="description"
          content="Prem Industries India Limited offers high-quality BOPP tapes for secure packaging needs. Trust our reliable solutions. Order BOPP tapes now!"
        />
      </Head>
          ...
          >
            <div className="mt-2 d-flex flex-column">
              <p className={styles.catalogpath}>
                ...
                <span className={styles.spanee}>BOPP Tapes</span>
              </p>
              <div
