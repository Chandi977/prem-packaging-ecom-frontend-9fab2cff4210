...
const BoppTape = ({ brand, product, category, brandId, subCategoryId, q }) => {
  ...
  const handleApply = async () => {
    ...
    if (flags?.category) {
      ...
      const filteredProducts = dat?.data?.data.filter((product) => {
        return product.brand === "6557dbcc301ec4f2f426610b";
      });
  ...
  useEffect(() => {
    ...
    if (product) {
      const boppTapeProducts = product.filter(
        (product) => product.brand?.name === "Myntra"
      );
    ...
    if (flags?.size) {
      ...
      if (index === -1) {
        ...
        const data = {
          ...
          category: temp,
          brand: "6557dbcc301ec4f2f426610b", // Add the brand filter here
  ...
  return (
    <>
      <Head>
        <title>Buy Myntra Paper Bags Online | store.prempackaging</title>
        <meta name="title" content="Buy Myntra Paper Bags Online" />
        <meta
          name="description"
          content="Buy high-quality, eco-friendly Myntra paper bags Online at store.prempackaging.com. Perfect for retail needs. Order now for fast delivery and sustainable packaging!"
        />
      </Head>
          ...
          >
            <div className="mt-2 d-flex flex-column">
              <p className={styles.catalogpath}>
                ...
                <span className={styles.spanee}>Myntra </span>
              </p>
              <div
            ...
            <div className="row mt-4" style={{ position: "relative" }}>
              ...
              <div className={"col-9 p-0 mt-4 " + styles.productslistdivwindow}>
