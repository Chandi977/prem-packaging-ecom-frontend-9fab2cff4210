...
const BoppTape = ({ brand, product, category, brandId, subCategoryId, q }) => {
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      if (flags?.category) {
        ...
        const dat = await postService("bopp/filter", data);
  ...
  useEffect(() => {
    // Filter products by categories "BOPP Tape" and "Paper Tape"
    if (product) {
      const filteredProducts = product.filter(
        (product) =>
          product.category?.name === "BOPP Tape" ||
          product.category?.name === "Paper Tape" ||
          product?.category?.name === "Speciality Tape" ||
          product?.category?.name === "Carry Handle Tape" ||
          product?.category?.name === "Food Wrapping Paper"
      );
      setProducts(filteredProducts);
    }
  }, [product]);
  ...
  return (
    <>
      <Head>
        <title>Buy PackPro Products online India | store.prempackaging</title>
        <meta name="title" content="Buy PackPro Products online India" />
        <meta
          name="description"
          content="Buy packaging tapes, Carry Handle Tape online at store.prempackaging. We provide BOPP tape, Paper tape, Carry Handle Tape at affordable prices for all your packaging requirement."
        />
      </Head>
          ...
          >
            <div className="mt-2 d-flex flex-column">
              <p className={styles.catalogpath}>
                ...
                <span className={styles.spanee}> Tape</span>
              </p>
              <div
            ...
            <div className="row mt-4 d-flex" style={{ position: "relative" }}>
              <div className="d-flex flex-column col-md-3">
                  ...
                  >
                    ...
                    >
                      <div className="col">
                        ...
                        <p className="mb-0 mt-2">Thickness (micron)</p>
                        <div className="mt-2 d-flex flex-row align-items-center justify-content-between">
                          <p
                            className="mb-0 px-2 bg-light"
                            style={{
                ...
                <div className={"mt-2 col-12 m-0 p-0" + styles.filterslayout}>
                  <div
                    className="w-100"
                    style={{ height: "275px", border: "1px solid #E6E6E6" }}
                  >
                    <div
                      className="row m-0"
                      style={{ paddingLeft: 3, paddingRight: 3 }}
                        ...
                        <div className="mt-4 d-flex flex-column align-items-start gap-3">
                          <div className="d-flex ">
                            <Checkbox
                              ...
                              iconStyle={{ fill: "gray" }}
                              onChange={() =>
                                handlecat("6557df64301ec4f2f4266141")
                              }
                              sx={{
                                padding: "0px",
                                color: "gray",
                          ...
                          <div className="d-flex ">
                            <Checkbox
                              ...
                              iconStyle={{ fill: "gray" }}
                              onChange={() =>
                                handlecat("6557df71301ec4f2f4266145")
                              }
                              sx={{
                                padding: "0px",
                                color: "gray",
                          ...
                          <div className="d-flex ">
                            <Checkbox
                              ...
                              iconStyle={{ fill: "gray" }}
                              onChange={() =>
                                handlecat("67cac1fc2a4e1c9ef44a92b5")
                              }
                              sx={{
                                padding: "0px",
                                color: "gray",
                          ...
                          <div className="d-flex ">
                            <Checkbox
                              ...
                              iconStyle={{ fill: "gray" }}
                              onChange={() =>
                                handlecat("679ca70f2833ca433fa0aa9c")
                              }
                              sx={{
                                padding: "0px",
                                color: "gray",
                          ...
                          <div className="d-flex ">
                            <Checkbox
                              ...
                              iconStyle={{ fill: "gray" }}
                              onChange={() =>
                                handlecat("6642e8f665f20fe41ab417bc")
                              }
                              sx={{
                                padding: "0px",
                                color: "gray",
              ...
              <div className={"col-md-9 " + styles.productslistdivwindow}>
