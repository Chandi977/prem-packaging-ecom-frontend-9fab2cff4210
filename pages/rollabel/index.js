    ...
    try {
      ...
      if (flags?.category) {
        ...
        const filteredProducts = dat?.data?.data.filter((product) => {
          return product.category === "6557deb6301ec4f2f4266135";
        });
  ...
  useEffect(() => {
    if (product) {
      const labelProducts = product.filter(
        (product) => product.category?.name === "Label"
      );
    ...
    if (flags?.size) {
      ...
      if (index === -1) {
        ...
        const filteredProducts = dat?.data?.data?.filter(
          (product) => product.category === "6557deb6301ec4f2f4266135"
        );
        setProducts(filteredProducts);
      } else {
        temp.splice(index, 1);
        setSelectedBrand(temp);
        const data = {
          category: "6557deb6301ec4f2f4266135",
        };
        const dat = await postService("/product/filter", data);
        //console.log("326", dat);
        const filteredProducts = dat?.data?.data?.filter(
          ...
          >
            <div className="mt-2 d-flex flex-column">
              <p className={styles.catalogpath}>
                ...
                <span className={styles.spanee}>Label</span>
              </p>
              <div
            ...
            <div className="row mt-4 d-flex" style={{ position: "relative" }}>
              <div className="col-md-3 ">
                ...
                <div className={"mt-4 col-12 p-0 m-0 " + styles.filterslayout}>
                  <div
                    className="w-100"
                        ...
                        <div className="mt-4 d-flex flex-column align-items-start gap-3">
                          <div className="d-flex ">
                            <Checkbox
                              ...
                              iconStyle={{ fill: "gray" }}
                              onChange={() =>
                                handlecat("6557e1cb301ec4f2f426614c")
                              }
                              sx={{
                                padding: "0px",
                                color: "gray",
                          ...
                          <div className="d-flex ">
                            <Checkbox
                              ...
                              iconStyle={{ fill: "gray" }}
                              onChange={() =>
                                handlecat("6557e236301ec4f2f4266154")
                              }
                              sx={{
                                padding: "0px",
                                color: "gray",
              ...
              {products && products.length > 0 ? (
                ...
                <div style={{ position: "absolute", top: "10%", left: "50%" }}>
                  <p className={styles.noProducts}>Sorry , No products found</p>
                </div>
              )}
